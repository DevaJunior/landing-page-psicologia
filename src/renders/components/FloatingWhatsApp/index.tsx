...
const FloatingWhatsApp: React.FC = () => {
  const { whatsappNumber } = siteContent.global;
  const message = encodeURIComponent("Olá, Dra. Paula. Gostaria de agendar uma consulta.");
  ...
  return (
    ...
    >
      {/* SVG com o Logotipo Oficial do WhatsApp */}
      <svg 
